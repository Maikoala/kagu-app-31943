...
| ------------------------------------------------------------------ | ------------------------------------------------------------------ |
|<img src="https://i.gyazo.com/82da2418382b7698c37240fd604d24e4.gif" width="400px">|<img src="https://i.gyazo.com/36103bd931403ec70887b1ce4791f966.gif" width="400px">|
...
| 新規登録                                                            | ログイン画面                                                         |
| ------------------------------------------------------------------ | ------------------------------------------------------------------ |
|<img src="https://i.gyazo.com/214cb89452da90a052f95b3b419d7147.gif" width="400px">|<img src="https://i.gyazo.com/5763b6268b57ed16326913e2a05f6b61.jpg" width="400px">|

| トップページ商品検索・shop一覧                                         | 各ページ商品検索                                                         |
| ------------------------------------------------------------------ | ------------------------------------------------------------------ |
|<img src="https://i.gyazo.com/5fc1c59d32d30600c2005d99b160deea.gif" width="400px">|<img src="https://i.gyazo.com/228a2113317e57a23c173c9a26af8513.gif" width="400px">|

| 商品詳細画面                                                         | 商品購入画面                                                         |
| ------------------------------------------------------------------ | ------------------------------------------------------------------ |
|<img src="https://i.gyazo.com/66fcf15c1934f0df0ee6f8c6e4976e8e.gif" width="400px">|<img src="https://i.gyazo.com/3f326eacd4a322224372d74f499ed4bc.gif" width="400px">|

| ユーザーマイページ画面                                                         | 
| -------------------------------------------------------------------------- | 
|<img src="https://i.gyazo.com/d3b0ee2775729dd0495c57e9d4be0525.jpg" width="400px">|
...
| 商品出品機能            | ログイン中のオーナーでショップ出店者は、画像(複数枚)付きでそのショップに商品出品が可能        |
...
| オーナー情報編集機能     | ログイン中のオーナーでアカウント本人はオーナー情報編集可能                                 |
| ユーザー詳細表示機能 　　 | ログイン中ユーザーでアカウント本人の購入済商品一覧の閲覧、ユーザー情報編集が可能|
| ユーザー情報編集機能     | ログイン中のユーザーでアカウント本人であればユーザー情報編集が可能                          |
<br>

## 追加予定機能
| 機能          | 概要                                                                                                        |
| ------------ | ----------------------------------------------------------------------------------------------------------- |
| お気に入り機能 | 各商品に非同期通信でお気に入りをつけることが可能、またその削除も可能、ユーザー詳細表示からユーザーのお気に入り一覧の閲覧可能     |
<br>
